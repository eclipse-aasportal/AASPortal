...
const MODEL_TYPE_FROM_STRING = new Map<string, AasTypes.ModelType>([
    ...
    ['LangStringPreferredNameTypeIec61360', AasTypes.ModelType.LangStringPreferredNameTypeIec61360],
...
const MODEL_TYPE_TO_STRING = new Map<AasTypes.ModelType, string>([
    ...
    [AasTypes.ModelType.LangStringPreferredNameTypeIec61360, 'LangStringPreferredNameTypeIec61360'],
    [AasTypes.ModelType.LangStringShortNameTypeIec61360, 'LangStringShortNameTypeIec61360'],
    [AasTypes.ModelType.LangStringDefinitionTypeIec61360, 'LangStringDefinitionTypeIec61360'],
 ...
 */
export function aasSubmodelElementsFromString(text: string): AasTypes.AasSubmodelElements | null {
 ...
 */
export function aasSubmodelElementsToString(value: AasTypes.AasSubmodelElements): string | null {
 ...
 * if the `value` is invalid
 */
export function mustAasSubmodelElementsToString(value: AasTypes.AasSubmodelElements): string {
    const result = AAS_SUBMODEL_ELEMENTS_TO_STRING.get(value);
    if (result === undefined) {
 ...
 */
export function dataTypeIec61360FromString(text: string): AasTypes.DataTypeIec61360 | null {
 ...
 */
export function dataTypeIec61360ToString(value: AasTypes.DataTypeIec61360): string | null {
