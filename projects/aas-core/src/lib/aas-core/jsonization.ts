...
import * as AasCommon from './common.js';
import * as AasTypes from './types.js';
import * as AasStringification from './stringification.js';
 ...
 */
function newDeserializationError<T>(message: string): AasCommon.Either<T, DeserializationError> {
    return new AasCommon.Either<T, DeserializationError>(null, new DeserializationError(message));
}
 ...
 */
function booleanFromJsonable(jsonable: JsonValue): AasCommon.Either<boolean, DeserializationError> {
    ...
    if (typeof jsonable !== 'boolean') {
        return newDeserializationError<boolean>(`Expected a boolean, but got ${typeof jsonable}`);
    }
...
function integerFromJsonable(jsonable: JsonValue): AasCommon.Either<number, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<number>('Expected an integer number, but got null');
    }
    if (typeof jsonable !== 'number') {
        return newDeserializationError<number>(`Expected an integer number, but got: ${typeof jsonable}`);
    }

    if (!Number.isInteger(jsonable)) {
        return newDeserializationError<number>(`Expected an integer number, but got: ${jsonable}`);
    }
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
function numberFromJsonable(jsonable: JsonValue): AasCommon.Either<number, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<number>('Expected a number, but got null');
    }
    if (typeof jsonable !== 'number') {
        return newDeserializationError<number>(`Expected a number, but got: ${typeof jsonable}`);
    }
 ...
 */
function stringFromJsonable(jsonable: JsonValue): AasCommon.Either<string, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<string>('Expected a string, but got null');
    }
    if (typeof jsonable !== 'string') {
        return newDeserializationError<string>(`Expected a string, but got: ${typeof jsonable}`);
    }
 ...
 */
function bytesFromJsonable(jsonable: JsonValue): AasCommon.Either<Uint8Array, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<Uint8Array>('Expected a base64-encoded string, but got null');
    }
    if (typeof jsonable !== 'string') {
        return newDeserializationError<Uint8Array>(`Expected a base64-encoded string, but got: ${typeof jsonable}`);
    }
    ...
    return new AasCommon.Either<Uint8Array, DeserializationError>(either.mustValue(), null);
}
...
export function hasSemanticsFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.IHasSemantics>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.IHasSemantics>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.IHasSemantics>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }

    const modelType = jsonable['modelType'];
    if (modelType === undefined) {
        return newDeserializationError<AasTypes.IHasSemantics>('The required property modelType is missing');
    }
    ...
    if (dispatch === undefined) {
        return newDeserializationError<AasTypes.IHasSemantics>(`Unexpected model type for IHasSemantics: ${modelType}`);
    }
...
class SetterForExtension {
     ...
     * @returns error, if any
     */
    setSupplementalSemanticIdsFromJsonable(jsonable: JsonValue): DeserializationError | null {
        if (jsonable === null) {
 ...
 * or an error if any
 */
export function extensionFromJsonable(jsonable: JsonValue): AasCommon.Either<AasTypes.Extension, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<AasTypes.Extension>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.Extension>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.Extension>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            ...
            return new AasCommon.Either<AasTypes.Extension, DeserializationError>(null, error);
        }
    }

    if (setter.name === null) {
        return newDeserializationError<AasTypes.Extension>("The required property 'name' is missing");
    }
...
export function hasExtensionsFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.IHasExtensions>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.IHasExtensions>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.IHasExtensions>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }

    const modelType = jsonable['modelType'];
    if (modelType === undefined) {
        return newDeserializationError<AasTypes.IHasExtensions>('The required property modelType is missing');
    }
...
export function referableFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.IReferable>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.IReferable>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.IReferable>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }

    const modelType = jsonable['modelType'];
    if (modelType === undefined) {
        return newDeserializationError<AasTypes.IReferable>('The required property modelType is missing');
    }
    ...
    if (dispatch === undefined) {
        return newDeserializationError<AasTypes.IReferable>(`Unexpected model type for IReferable: ${modelType}`);
    }
...
export function identifiableFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.IIdentifiable>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.IIdentifiable>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.IIdentifiable>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }

    const modelType = jsonable['modelType'];
    if (modelType === undefined) {
        return newDeserializationError<AasTypes.IIdentifiable>('The required property modelType is missing');
    }
    ...
    if (dispatch === undefined) {
        return newDeserializationError<AasTypes.IIdentifiable>(`Unexpected model type for IIdentifiable: ${modelType}`);
    }
...
export function modellingKindFromJsonable(
    ...
    if (typeof jsonable !== 'string') {
        return newDeserializationError<AasTypes.ModellingKind>(`Expected a string, but got: ${typeof jsonable}`);
    }

    const literal = AasStringification.modellingKindFromString(jsonable);
    if (literal === null) {
        return newDeserializationError<AasTypes.ModellingKind>(
            'Not a valid string representation of ' + `a literal of ModellingKind: ${jsonable}`,
        );
    }

    return new AasCommon.Either<AasTypes.ModellingKind, DeserializationError>(literal, null);
}
 ...
 * @returns parsed instance, or error if `jsonable` is invalid
 */
export function hasKindFromJsonable(jsonable: JsonValue): AasCommon.Either<AasTypes.IHasKind, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<AasTypes.IHasKind>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.IHasKind>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.IHasKind>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }

    const modelType = jsonable['modelType'];
    if (modelType === undefined) {
        return newDeserializationError<AasTypes.IHasKind>('The required property modelType is missing');
    }
    ...
    if (dispatch === undefined) {
        return newDeserializationError<AasTypes.IHasKind>(`Unexpected model type for IHasKind: ${modelType}`);
    }
...
export function hasDataSpecificationFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.IHasDataSpecification>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.IHasDataSpecification>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
    ...
    const modelType = jsonable['modelType'];
    if (modelType === undefined) {
        return newDeserializationError<AasTypes.IHasDataSpecification>('The required property modelType is missing');
    }
...
class SetterForAdministrativeInformation {
     ...
     * @returns error, if any
     */
    setEmbeddedDataSpecificationsFromJsonable(jsonable: JsonValue): DeserializationError | null {
        if (jsonable === null) {
            return new DeserializationError('Expected an iterable, but got null');
        }
        if (typeof jsonable !== 'object') {
...
export function administrativeInformationFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.AdministrativeInformation>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.AdministrativeInformation, DeserializationError>(null, error);
        }
    }
...
export function qualifiableFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.IQualifiable>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.IQualifiable>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.IQualifiable>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }

    const modelType = jsonable['modelType'];
    if (modelType === undefined) {
        return newDeserializationError<AasTypes.IQualifiable>('The required property modelType is missing');
    }
    ...
    if (dispatch === undefined) {
        return newDeserializationError<AasTypes.IQualifiable>(`Unexpected model type for IQualifiable: ${modelType}`);
    }
...
export function qualifierKindFromJsonable(
    ...
    if (typeof jsonable !== 'string') {
        return newDeserializationError<AasTypes.QualifierKind>(`Expected a string, but got: ${typeof jsonable}`);
    }

    const literal = AasStringification.qualifierKindFromString(jsonable);
    if (literal === null) {
        return newDeserializationError<AasTypes.QualifierKind>(
            'Not a valid string representation of ' + `a literal of QualifierKind: ${jsonable}`,
        );
    }

    return new AasCommon.Either<AasTypes.QualifierKind, DeserializationError>(literal, null);
}
 ...
 * or an error if any
 */
export function qualifierFromJsonable(jsonable: JsonValue): AasCommon.Either<AasTypes.Qualifier, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<AasTypes.Qualifier>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.Qualifier>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.Qualifier>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.Qualifier, DeserializationError>(null, error);
        }
    }

    if (setter.type === null) {
        return newDeserializationError<AasTypes.Qualifier>("The required property 'type' is missing");
    }

    if (setter.valueType === null) {
        return newDeserializationError<AasTypes.Qualifier>("The required property 'valueType' is missing");
    }
...
class SetterForAssetAdministrationShell {
     ...
     * @returns error, if any
     */
    setModelTypeFromJsonable(jsonable: JsonValue): DeserializationError | null {
        const parsedOrError = stringFromJsonable(jsonable);
        if (parsedOrError.error !== null) {
            return parsedOrError.error;
        } else {
...
export function assetAdministrationShellFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.AssetAdministrationShell>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.AssetAdministrationShell, DeserializationError>(null, error);
        }
    }

    if (setter.id === null) {
        return newDeserializationError<AasTypes.AssetAdministrationShell>("The required property 'id' is missing");
    }
    ...
    if (setter.modelType === null) {
        ...
        return newDeserializationError<AasTypes.AssetAdministrationShell>(
            "Expected model type 'AssetAdministrationShell', " + `but got: ${setter.modelType}`,
        );
    }
...
export function assetInformationFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.AssetInformation>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.AssetInformation>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.AssetInformation, DeserializationError>(null, error);
        }
    }

    if (setter.assetKind === null) {
        return newDeserializationError<AasTypes.AssetInformation>("The required property 'assetKind' is missing");
    }
 ...
 * or an error if any
 */
export function resourceFromJsonable(jsonable: JsonValue): AasCommon.Either<AasTypes.Resource, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<AasTypes.Resource>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.Resource>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.Resource>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }
    ...
    if (setter.path === null) {
        return newDeserializationError<AasTypes.Resource>("The required property 'path' is missing");
    }
 ...
 * @returns parsed literal, or an error if `jsonable` invalid
 */
export function assetKindFromJsonable(jsonable: JsonValue): AasCommon.Either<AasTypes.AssetKind, DeserializationError> {
    if (typeof jsonable !== 'string') {
        return newDeserializationError<AasTypes.AssetKind>(`Expected a string, but got: ${typeof jsonable}`);
    }
...
export function specificAssetIdFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.SpecificAssetId>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.SpecificAssetId>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.SpecificAssetId>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.SpecificAssetId, DeserializationError>(null, error);
        }
    }

    if (setter.name === null) {
        return newDeserializationError<AasTypes.SpecificAssetId>("The required property 'name' is missing");
    }

    if (setter.value === null) {
        return newDeserializationError<AasTypes.SpecificAssetId>("The required property 'value' is missing");
    }
 ...
 * or an error if any
 */
export function submodelFromJsonable(jsonable: JsonValue): AasCommon.Either<AasTypes.Submodel, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<AasTypes.Submodel>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.Submodel>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.Submodel>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }
    ...
    if (setter.id === null) {
        return newDeserializationError<AasTypes.Submodel>("The required property 'id' is missing");
    }

    if (setter.modelType === null) {
        return newDeserializationError<AasTypes.Submodel>("The required property 'modelType' is missing");
    } else if (setter.modelType != 'Submodel') {
        return newDeserializationError<AasTypes.Submodel>(
            "Expected model type 'Submodel', " + `but got: ${setter.modelType}`,
        );
    }
...
export function submodelElementFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.ISubmodelElement>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.ISubmodelElement>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
    ...
    const modelType = jsonable['modelType'];
    if (modelType === undefined) {
        return newDeserializationError<AasTypes.ISubmodelElement>('The required property modelType is missing');
    }
...
export function relationshipElementFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.IRelationshipElement>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.IRelationshipElement>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
    ...
    const modelType = jsonable['modelType'];
    if (modelType === undefined) {
        return newDeserializationError<AasTypes.IRelationshipElement>('The required property modelType is missing');
    }
...
function relationshipElementFromJsonableWithoutDispatch(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.RelationshipElement>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.RelationshipElement>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.RelationshipElement, DeserializationError>(null, error);
        }
    }

    if (setter.first === null) {
        return newDeserializationError<AasTypes.RelationshipElement>("The required property 'first' is missing");
    }

    if (setter.second === null) {
        return newDeserializationError<AasTypes.RelationshipElement>("The required property 'second' is missing");
    }

    if (setter.modelType === null) {
        return newDeserializationError<AasTypes.RelationshipElement>("The required property 'modelType' is missing");
    } else if (setter.modelType != 'RelationshipElement') {
        return newDeserializationError<AasTypes.RelationshipElement>(
            "Expected model type 'RelationshipElement', " + `but got: ${setter.modelType}`,
        );
    }
...
export function aasSubmodelElementsFromJsonable(
    ...
    if (typeof jsonable !== 'string') {
        return newDeserializationError<AasTypes.AasSubmodelElements>(`Expected a string, but got: ${typeof jsonable}`);
    }
    ...
    if (literal === null) {
        return newDeserializationError<AasTypes.AasSubmodelElements>(
            'Not a valid string representation of ' + `a literal of AasSubmodelElements: ${jsonable}`,
        );
    }

    return new AasCommon.Either<AasTypes.AasSubmodelElements, DeserializationError>(literal, null);
}
...
class SetterForSubmodelElementList {
     ...
     * @returns error, if any
     */
    setSemanticIdListElementFromJsonable(jsonable: JsonValue): DeserializationError | null {
        const parsedOrError = referenceFromJsonable(jsonable);
        if (parsedOrError.error !== null) {
            return parsedOrError.error;
        } else {
     ...
     * @returns error, if any
     */
    setTypeValueListElementFromJsonable(jsonable: JsonValue): DeserializationError | null {
     ...
     * @returns error, if any
     */
    setValueTypeListElementFromJsonable(jsonable: JsonValue): DeserializationError | null {
        const parsedOrError = dataTypeDefXsdFromJsonable(jsonable);
        if (parsedOrError.error !== null) {
            return parsedOrError.error;
        } else {
...
export function submodelElementListFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.SubmodelElementList>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.SubmodelElementList>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.SubmodelElementList, DeserializationError>(null, error);
        }
    }
    ...
    if (setter.modelType === null) {
        return newDeserializationError<AasTypes.SubmodelElementList>("The required property 'modelType' is missing");
    } else if (setter.modelType != 'SubmodelElementList') {
        return newDeserializationError<AasTypes.SubmodelElementList>(
            "Expected model type 'SubmodelElementList', " + `but got: ${setter.modelType}`,
        );
    }
...
export function submodelElementCollectionFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.SubmodelElementCollection>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.SubmodelElementCollection, DeserializationError>(null, error);
        }
    }
    ...
    if (setter.modelType === null) {
        ...
        return newDeserializationError<AasTypes.SubmodelElementCollection>(
            "Expected model type 'SubmodelElementCollection', " + `but got: ${setter.modelType}`,
        );
    }
...
export function dataElementFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.IDataElement>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.IDataElement>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.IDataElement>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }

    const modelType = jsonable['modelType'];
    if (modelType === undefined) {
        return newDeserializationError<AasTypes.IDataElement>('The required property modelType is missing');
    }
    ...
    if (dispatch === undefined) {
        return newDeserializationError<AasTypes.IDataElement>(`Unexpected model type for IDataElement: ${modelType}`);
    }
 ...
 * or an error if any
 */
export function propertyFromJsonable(jsonable: JsonValue): AasCommon.Either<AasTypes.Property, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<AasTypes.Property>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.Property>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.Property>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }
    ...
    if (setter.valueType === null) {
        return newDeserializationError<AasTypes.Property>("The required property 'valueType' is missing");
    }

    if (setter.modelType === null) {
        return newDeserializationError<AasTypes.Property>("The required property 'modelType' is missing");
    } else if (setter.modelType != 'Property') {
        return newDeserializationError<AasTypes.Property>(
            "Expected model type 'Property', " + `but got: ${setter.modelType}`,
        );
    }
...
export function multiLanguagePropertyFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.MultiLanguageProperty>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.MultiLanguageProperty>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.MultiLanguageProperty, DeserializationError>(null, error);
        }
    }

    if (setter.modelType === null) {
        return newDeserializationError<AasTypes.MultiLanguageProperty>("The required property 'modelType' is missing");
    } else if (setter.modelType != 'MultiLanguageProperty') {
        return newDeserializationError<AasTypes.MultiLanguageProperty>(
            "Expected model type 'MultiLanguageProperty', " + `but got: ${setter.modelType}`,
        );
    }
 ...
 * or an error if any
 */
export function rangeFromJsonable(jsonable: JsonValue): AasCommon.Either<AasTypes.Range, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<AasTypes.Range>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.Range>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.Range>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }
    ...
    if (setter.valueType === null) {
        return newDeserializationError<AasTypes.Range>("The required property 'valueType' is missing");
    }

    if (setter.modelType === null) {
        return newDeserializationError<AasTypes.Range>("The required property 'modelType' is missing");
    } else if (setter.modelType != 'Range') {
        return newDeserializationError<AasTypes.Range>(
            "Expected model type 'Range', " + `but got: ${setter.modelType}`,
        );
    }
...
export function referenceElementFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.ReferenceElement>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.ReferenceElement>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.ReferenceElement, DeserializationError>(null, error);
        }
    }

    if (setter.modelType === null) {
        return newDeserializationError<AasTypes.ReferenceElement>("The required property 'modelType' is missing");
    } else if (setter.modelType != 'ReferenceElement') {
        return newDeserializationError<AasTypes.ReferenceElement>(
            "Expected model type 'ReferenceElement', " + `but got: ${setter.modelType}`,
        );
    }
 ...
 * or an error if any
 */
export function blobFromJsonable(jsonable: JsonValue): AasCommon.Either<AasTypes.Blob, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<AasTypes.Blob>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.Blob>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.Blob>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }
    ...
    if (setter.contentType === null) {
        return newDeserializationError<AasTypes.Blob>("The required property 'contentType' is missing");
    }

    if (setter.modelType === null) {
        return newDeserializationError<AasTypes.Blob>("The required property 'modelType' is missing");
    } else if (setter.modelType != 'Blob') {
        return newDeserializationError<AasTypes.Blob>("Expected model type 'Blob', " + `but got: ${setter.modelType}`);
    }
 ...
 * or an error if any
 */
export function fileFromJsonable(jsonable: JsonValue): AasCommon.Either<AasTypes.File, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<AasTypes.File>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.File>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.File>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }
    ...
    if (setter.contentType === null) {
        return newDeserializationError<AasTypes.File>("The required property 'contentType' is missing");
    }

    if (setter.modelType === null) {
        return newDeserializationError<AasTypes.File>("The required property 'modelType' is missing");
    } else if (setter.modelType != 'File') {
        return newDeserializationError<AasTypes.File>("Expected model type 'File', " + `but got: ${setter.modelType}`);
    }
...
export function annotatedRelationshipElementFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.AnnotatedRelationshipElement>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.AnnotatedRelationshipElement, DeserializationError>(null, error);
        }
    }
    ...
    if (setter.modelType === null) {
        ...
        return newDeserializationError<AasTypes.AnnotatedRelationshipElement>(
            "Expected model type 'AnnotatedRelationshipElement', " + `but got: ${setter.modelType}`,
        );
    }
 ...
 * or an error if any
 */
export function entityFromJsonable(jsonable: JsonValue): AasCommon.Either<AasTypes.Entity, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<AasTypes.Entity>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.Entity>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.Entity>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }
    ...
    if (setter.entityType === null) {
        return newDeserializationError<AasTypes.Entity>("The required property 'entityType' is missing");
    }

    if (setter.modelType === null) {
        return newDeserializationError<AasTypes.Entity>("The required property 'modelType' is missing");
    } else if (setter.modelType != 'Entity') {
        return newDeserializationError<AasTypes.Entity>(
            "Expected model type 'Entity', " + `but got: ${setter.modelType}`,
        );
    }
...
export function entityTypeFromJsonable(
    ...
    if (typeof jsonable !== 'string') {
        return newDeserializationError<AasTypes.EntityType>(`Expected a string, but got: ${typeof jsonable}`);
    }
 ...
 * @returns parsed literal, or an error if `jsonable` invalid
 */
export function directionFromJsonable(jsonable: JsonValue): AasCommon.Either<AasTypes.Direction, DeserializationError> {
    if (typeof jsonable !== 'string') {
        return newDeserializationError<AasTypes.Direction>(`Expected a string, but got: ${typeof jsonable}`);
    }
...
export function stateOfEventFromJsonable(
    ...
    if (typeof jsonable !== 'string') {
        return newDeserializationError<AasTypes.StateOfEvent>(`Expected a string, but got: ${typeof jsonable}`);
    }
    ...
    return new AasCommon.Either<AasTypes.StateOfEvent, DeserializationError>(literal, null);
}
...
class SetterForEventPayload {
     ...
     * @returns error, if any
     */
    setObservableSemanticIdFromJsonable(jsonable: JsonValue): DeserializationError | null {
        const parsedOrError = referenceFromJsonable(jsonable);
        if (parsedOrError.error !== null) {
            return parsedOrError.error;
        } else {
...
export function eventPayloadFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.EventPayload>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.EventPayload>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.EventPayload>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.EventPayload, DeserializationError>(null, error);
        }
    }

    if (setter.source === null) {
        return newDeserializationError<AasTypes.EventPayload>("The required property 'source' is missing");
    }

    if (setter.observableReference === null) {
        return newDeserializationError<AasTypes.EventPayload>("The required property 'observableReference' is missing");
    }

    if (setter.timeStamp === null) {
        return newDeserializationError<AasTypes.EventPayload>("The required property 'timeStamp' is missing");
    }
...
export function eventElementFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.IEventElement>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.IEventElement>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.IEventElement>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }

    const modelType = jsonable['modelType'];
    if (modelType === undefined) {
        return newDeserializationError<AasTypes.IEventElement>('The required property modelType is missing');
    }
    ...
    if (dispatch === undefined) {
        return newDeserializationError<AasTypes.IEventElement>(`Unexpected model type for IEventElement: ${modelType}`);
    }
...
export function basicEventElementFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.BasicEventElement>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.BasicEventElement>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.BasicEventElement, DeserializationError>(null, error);
        }
    }

    if (setter.observed === null) {
        return newDeserializationError<AasTypes.BasicEventElement>("The required property 'observed' is missing");
    }

    if (setter.direction === null) {
        return newDeserializationError<AasTypes.BasicEventElement>("The required property 'direction' is missing");
    }

    if (setter.state === null) {
        return newDeserializationError<AasTypes.BasicEventElement>("The required property 'state' is missing");
    }

    if (setter.modelType === null) {
        return newDeserializationError<AasTypes.BasicEventElement>("The required property 'modelType' is missing");
    } else if (setter.modelType != 'BasicEventElement') {
        return newDeserializationError<AasTypes.BasicEventElement>(
            "Expected model type 'BasicEventElement', " + `but got: ${setter.modelType}`,
        );
    }
 ...
 * or an error if any
 */
export function operationFromJsonable(jsonable: JsonValue): AasCommon.Either<AasTypes.Operation, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<AasTypes.Operation>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.Operation>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.Operation>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.Operation, DeserializationError>(null, error);
        }
    }

    if (setter.modelType === null) {
        return newDeserializationError<AasTypes.Operation>("The required property 'modelType' is missing");
    } else if (setter.modelType != 'Operation') {
        return newDeserializationError<AasTypes.Operation>(
            "Expected model type 'Operation', " + `but got: ${setter.modelType}`,
        );
    }
...
export function operationVariableFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.OperationVariable>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.OperationVariable>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.OperationVariable, DeserializationError>(null, error);
        }
    }

    if (setter.value === null) {
        return newDeserializationError<AasTypes.OperationVariable>("The required property 'value' is missing");
    }
...
export function capabilityFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.Capability>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.Capability>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.Capability>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.Capability, DeserializationError>(null, error);
        }
    }

    if (setter.modelType === null) {
        return newDeserializationError<AasTypes.Capability>("The required property 'modelType' is missing");
    } else if (setter.modelType != 'Capability') {
        return newDeserializationError<AasTypes.Capability>(
            "Expected model type 'Capability', " + `but got: ${setter.modelType}`,
        );
    }
...
export function conceptDescriptionFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.ConceptDescription>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.ConceptDescription>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.ConceptDescription, DeserializationError>(null, error);
        }
    }

    if (setter.id === null) {
        return newDeserializationError<AasTypes.ConceptDescription>("The required property 'id' is missing");
    }

    if (setter.modelType === null) {
        return newDeserializationError<AasTypes.ConceptDescription>("The required property 'modelType' is missing");
    } else if (setter.modelType != 'ConceptDescription') {
        return newDeserializationError<AasTypes.ConceptDescription>(
            "Expected model type 'ConceptDescription', " + `but got: ${setter.modelType}`,
        );
    }
...
export function referenceTypesFromJsonable(
    ...
    if (typeof jsonable !== 'string') {
        return newDeserializationError<AasTypes.ReferenceTypes>(`Expected a string, but got: ${typeof jsonable}`);
    }

    const literal = AasStringification.referenceTypesFromString(jsonable);
    if (literal === null) {
        return newDeserializationError<AasTypes.ReferenceTypes>(
            'Not a valid string representation of ' + `a literal of ReferenceTypes: ${jsonable}`,
        );
    }

    return new AasCommon.Either<AasTypes.ReferenceTypes, DeserializationError>(literal, null);
}
 ...
 * or an error if any
 */
export function referenceFromJsonable(jsonable: JsonValue): AasCommon.Either<AasTypes.Reference, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<AasTypes.Reference>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.Reference>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.Reference>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.Reference, DeserializationError>(null, error);
        }
    }

    if (setter.type === null) {
        return newDeserializationError<AasTypes.Reference>("The required property 'type' is missing");
    }

    if (setter.keys === null) {
        return newDeserializationError<AasTypes.Reference>("The required property 'keys' is missing");
    }
 ...
 * or an error if any
 */
export function keyFromJsonable(jsonable: JsonValue): AasCommon.Either<AasTypes.Key, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<AasTypes.Key>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.Key>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.Key>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }
    ...
    if (setter.type === null) {
        return newDeserializationError<AasTypes.Key>("The required property 'type' is missing");
    }

    if (setter.value === null) {
        return newDeserializationError<AasTypes.Key>("The required property 'value' is missing");
    }

    return new AasCommon.Either<AasTypes.Key, DeserializationError>(new AasTypes.Key(setter.type, setter.value), null);
}
 ...
 * @returns parsed literal, or an error if `jsonable` invalid
 */
export function keyTypesFromJsonable(jsonable: JsonValue): AasCommon.Either<AasTypes.KeyTypes, DeserializationError> {
    if (typeof jsonable !== 'string') {
        return newDeserializationError<AasTypes.KeyTypes>(`Expected a string, but got: ${typeof jsonable}`);
    }
...
export function dataTypeDefXsdFromJsonable(
    ...
    if (typeof jsonable !== 'string') {
        return newDeserializationError<AasTypes.DataTypeDefXsd>(`Expected a string, but got: ${typeof jsonable}`);
    }

    const literal = AasStringification.dataTypeDefXsdFromString(jsonable);
    if (literal === null) {
        return newDeserializationError<AasTypes.DataTypeDefXsd>(
            'Not a valid string representation of ' + `a literal of DataTypeDefXsd: ${jsonable}`,
        );
    }

    return new AasCommon.Either<AasTypes.DataTypeDefXsd, DeserializationError>(literal, null);
}
...
export function abstractLangStringFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.IAbstractLangString>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.IAbstractLangString>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
    ...
    const modelType = jsonable['modelType'];
    if (modelType === undefined) {
        return newDeserializationError<AasTypes.IAbstractLangString>('The required property modelType is missing');
    }
...
export function langStringNameTypeFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.LangStringNameType>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.LangStringNameType>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.LangStringNameType, DeserializationError>(null, error);
        }
    }

    if (setter.language === null) {
        return newDeserializationError<AasTypes.LangStringNameType>("The required property 'language' is missing");
    }

    if (setter.text === null) {
        return newDeserializationError<AasTypes.LangStringNameType>("The required property 'text' is missing");
    }
...
export function langStringTextTypeFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.LangStringTextType>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.LangStringTextType>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.LangStringTextType, DeserializationError>(null, error);
        }
    }

    if (setter.language === null) {
        return newDeserializationError<AasTypes.LangStringTextType>("The required property 'language' is missing");
    }

    if (setter.text === null) {
        return newDeserializationError<AasTypes.LangStringTextType>("The required property 'text' is missing");
    }
...
class SetterForEnvironment {
     ...
     * @returns error, if any
     */
    setAssetAdministrationShellsFromJsonable(jsonable: JsonValue): DeserializationError | null {
        if (jsonable === null) {
            return new DeserializationError('Expected an iterable, but got null');
        }
        if (typeof jsonable !== 'object') {
...
export function environmentFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.Environment>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.Environment>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.Environment>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.Environment, DeserializationError>(null, error);
        }
    }

    return new AasCommon.Either<AasTypes.Environment, DeserializationError>(
        new AasTypes.Environment(setter.assetAdministrationShells, setter.submodels, setter.conceptDescriptions),
        null,
    );
}
...
export function dataSpecificationContentFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.IDataSpecificationContent>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
...
class SetterForEmbeddedDataSpecification {
     ...
     * @returns error, if any
     */
    setDataSpecificationContentFromJsonable(jsonable: JsonValue): DeserializationError | null {
...
export function embeddedDataSpecificationFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.EmbeddedDataSpecification>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.EmbeddedDataSpecification, DeserializationError>(null, error);
        }
    }
    ...
    return new AasCommon.Either<AasTypes.EmbeddedDataSpecification, DeserializationError>(
        new AasTypes.EmbeddedDataSpecification(setter.dataSpecificationContent, setter.dataSpecification),
        null,
    );
}
...
export function dataTypeIec61360FromJsonable(
    ...
    if (typeof jsonable !== 'string') {
        return newDeserializationError<AasTypes.DataTypeIec61360>(`Expected a string, but got: ${typeof jsonable}`);
    }
    ...
    if (literal === null) {
        return newDeserializationError<AasTypes.DataTypeIec61360>(
            'Not a valid string representation of ' + `a literal of DataTypeIec61360: ${jsonable}`,
        );
    }

    return new AasCommon.Either<AasTypes.DataTypeIec61360, DeserializationError>(literal, null);
}
 ...
 * or an error if any
 */
export function levelTypeFromJsonable(jsonable: JsonValue): AasCommon.Either<AasTypes.LevelType, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<AasTypes.LevelType>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.LevelType>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.LevelType>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.LevelType, DeserializationError>(null, error);
        }
    }

    if (setter.min === null) {
        return newDeserializationError<AasTypes.LevelType>("The required property 'min' is missing");
    }

    if (setter.nom === null) {
        return newDeserializationError<AasTypes.LevelType>("The required property 'nom' is missing");
    }

    if (setter.typ === null) {
        return newDeserializationError<AasTypes.LevelType>("The required property 'typ' is missing");
    }

    if (setter.max === null) {
        return newDeserializationError<AasTypes.LevelType>("The required property 'max' is missing");
    }
...
export function valueReferencePairFromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.ValueReferencePair>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.ValueReferencePair>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.ValueReferencePair, DeserializationError>(null, error);
        }
    }

    if (setter.value === null) {
        return newDeserializationError<AasTypes.ValueReferencePair>("The required property 'value' is missing");
    }

    if (setter.valueId === null) {
        return newDeserializationError<AasTypes.ValueReferencePair>("The required property 'valueId' is missing");
    }
 ...
 * or an error if any
 */
export function valueListFromJsonable(jsonable: JsonValue): AasCommon.Either<AasTypes.ValueList, DeserializationError> {
    if (jsonable === null) {
        return newDeserializationError<AasTypes.ValueList>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
        return newDeserializationError<AasTypes.ValueList>('Expected a JSON object, but got a JSON array');
    }
    if (typeof jsonable !== 'object') {
        return newDeserializationError<AasTypes.ValueList>(`Expected a JSON object, but got: ${typeof jsonable}`);
    }
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.ValueList, DeserializationError>(null, error);
        }
    }

    if (setter.valueReferencePairs === null) {
        return newDeserializationError<AasTypes.ValueList>("The required property 'valueReferencePairs' is missing");
    }
...
export function langStringShortNameTypeIec61360FromJsonable(
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.LangStringShortNameTypeIec61360, DeserializationError>(null, error);
        }
    }
    ...
    return new AasCommon.Either<AasTypes.LangStringShortNameTypeIec61360, DeserializationError>(
        new AasTypes.LangStringShortNameTypeIec61360(setter.language, setter.text),
        null,
    );
}
...
export function langStringDefinitionTypeIec61360FromJsonable(
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.LangStringDefinitionTypeIec61360, DeserializationError>(null, error);
        }
    }
    ...
    return new AasCommon.Either<AasTypes.LangStringDefinitionTypeIec61360, DeserializationError>(
        new AasTypes.LangStringDefinitionTypeIec61360(setter.language, setter.text),
        null,
    );
}
...
export function dataSpecificationIec61360FromJsonable(
    ...
    if (jsonable === null) {
        return newDeserializationError<AasTypes.DataSpecificationIec61360>('Expected a JSON object, but got null');
    }
    if (Array.isArray(jsonable)) {
    ...
    for (const key in jsonable) {
        ...
        if (error !== null) {
            error.path.prepend(new PropertySegment(<JsonObject>jsonable, key));
            return new AasCommon.Either<AasTypes.DataSpecificationIec61360, DeserializationError>(null, error);
        }
    }
    ...
    if (setter.modelType === null) {
        ...
        return newDeserializationError<AasTypes.DataSpecificationIec61360>(
            "Expected model type 'DataSpecificationIec61360', " + `but got: ${setter.modelType}`,
        );
    }
...
const SETTER_MAP_FOR_EXTENSION = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
...
const SETTER_MAP_FOR_ADMINISTRATIVE_INFORMATION = new Map<string, (jsonable: JsonValue) => DeserializationError | null>(
    [
        [
        ...
        ['templateId', SetterForAdministrativeInformation.prototype.setTemplateIdFromJsonable],
    ],
);
...
const SETTER_MAP_FOR_QUALIFIER = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
...
const SETTER_MAP_FOR_ASSET_ADMINISTRATION_SHELL = new Map<string, (jsonable: JsonValue) => DeserializationError | null>(
    [
        ...
        ['displayName', SetterForAssetAdministrationShell.prototype.setDisplayNameFromJsonable],
        ['description', SetterForAssetAdministrationShell.prototype.setDescriptionFromJsonable],
        ['administration', SetterForAssetAdministrationShell.prototype.setAdministrationFromJsonable],
        ...
        ['derivedFrom', SetterForAssetAdministrationShell.prototype.setDerivedFromFromJsonable],
        ['assetInformation', SetterForAssetAdministrationShell.prototype.setAssetInformationFromJsonable],
...
const SETTER_MAP_FOR_ASSET_INFORMATION = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ...
    ['specificAssetIds', SetterForAssetInformation.prototype.setSpecificAssetIdsFromJsonable],
    ['assetType', SetterForAssetInformation.prototype.setAssetTypeFromJsonable],
    ['defaultThumbnail', SetterForAssetInformation.prototype.setDefaultThumbnailFromJsonable],
]);

const SETTER_MAP_FOR_RESOURCE = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ['path', SetterForResource.prototype.setPathFromJsonable],
    ['contentType', SetterForResource.prototype.setContentTypeFromJsonable],
]);

const SETTER_MAP_FOR_SPECIFIC_ASSET_ID = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ['semanticId', SetterForSpecificAssetId.prototype.setSemanticIdFromJsonable],
    ['supplementalSemanticIds', SetterForSpecificAssetId.prototype.setSupplementalSemanticIdsFromJsonable],
    ['name', SetterForSpecificAssetId.prototype.setNameFromJsonable],
    ['value', SetterForSpecificAssetId.prototype.setValueFromJsonable],
    ['externalSubjectId', SetterForSpecificAssetId.prototype.setExternalSubjectIdFromJsonable],
]);

const SETTER_MAP_FOR_SUBMODEL = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ...
    ['embeddedDataSpecifications', SetterForSubmodel.prototype.setEmbeddedDataSpecificationsFromJsonable],
...
const SETTER_MAP_FOR_RELATIONSHIP_ELEMENT = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ...
    ['embeddedDataSpecifications', SetterForRelationshipElement.prototype.setEmbeddedDataSpecificationsFromJsonable],
...
const SETTER_MAP_FOR_SUBMODEL_ELEMENT_LIST = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ...
    ['embeddedDataSpecifications', SetterForSubmodelElementList.prototype.setEmbeddedDataSpecificationsFromJsonable],
    ['orderRelevant', SetterForSubmodelElementList.prototype.setOrderRelevantFromJsonable],
    ['semanticIdListElement', SetterForSubmodelElementList.prototype.setSemanticIdListElementFromJsonable],
    ['typeValueListElement', SetterForSubmodelElementList.prototype.setTypeValueListElementFromJsonable],
    ['valueTypeListElement', SetterForSubmodelElementList.prototype.setValueTypeListElementFromJsonable],
...
>([
    ['extensions', SetterForSubmodelElementCollection.prototype.setExtensionsFromJsonable],
    ...
    ['displayName', SetterForSubmodelElementCollection.prototype.setDisplayNameFromJsonable],
    ['description', SetterForSubmodelElementCollection.prototype.setDescriptionFromJsonable],
    ['semanticId', SetterForSubmodelElementCollection.prototype.setSemanticIdFromJsonable],
    ['supplementalSemanticIds', SetterForSubmodelElementCollection.prototype.setSupplementalSemanticIdsFromJsonable],
    ['qualifiers', SetterForSubmodelElementCollection.prototype.setQualifiersFromJsonable],
    [
        'embeddedDataSpecifications',
...
const SETTER_MAP_FOR_PROPERTY = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ...
    ['embeddedDataSpecifications', SetterForProperty.prototype.setEmbeddedDataSpecificationsFromJsonable],
...
const SETTER_MAP_FOR_MULTI_LANGUAGE_PROPERTY = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ...
    ['embeddedDataSpecifications', SetterForMultiLanguageProperty.prototype.setEmbeddedDataSpecificationsFromJsonable],
...
const SETTER_MAP_FOR_RANGE = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ...
    ['embeddedDataSpecifications', SetterForRange.prototype.setEmbeddedDataSpecificationsFromJsonable],
...
const SETTER_MAP_FOR_REFERENCE_ELEMENT = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ...
    ['embeddedDataSpecifications', SetterForReferenceElement.prototype.setEmbeddedDataSpecificationsFromJsonable],
...
const SETTER_MAP_FOR_BLOB = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ...
    ['embeddedDataSpecifications', SetterForBlob.prototype.setEmbeddedDataSpecificationsFromJsonable],
...
const SETTER_MAP_FOR_FILE = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ...
    ['embeddedDataSpecifications', SetterForFile.prototype.setEmbeddedDataSpecificationsFromJsonable],
...
const SETTER_MAP_FOR_ANNOTATED_RELATIONSHIP_ELEMENT = new Map<
    ...
    (jsonable: JsonValue) => DeserializationError | null
>([
    ['extensions', SetterForAnnotatedRelationshipElement.prototype.setExtensionsFromJsonable],
    ...
    ['displayName', SetterForAnnotatedRelationshipElement.prototype.setDisplayNameFromJsonable],
    ['description', SetterForAnnotatedRelationshipElement.prototype.setDescriptionFromJsonable],
    ['semanticId', SetterForAnnotatedRelationshipElement.prototype.setSemanticIdFromJsonable],
    ['supplementalSemanticIds', SetterForAnnotatedRelationshipElement.prototype.setSupplementalSemanticIdsFromJsonable],
    ['qualifiers', SetterForAnnotatedRelationshipElement.prototype.setQualifiersFromJsonable],
    [
        'embeddedDataSpecifications',
    ...
    ['annotations', SetterForAnnotatedRelationshipElement.prototype.setAnnotationsFromJsonable],
    [
        // The model type here is used only for verification, not for dispatch.
        'modelType',
...
const SETTER_MAP_FOR_ENTITY = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ...
    ['embeddedDataSpecifications', SetterForEntity.prototype.setEmbeddedDataSpecificationsFromJsonable],
...
const SETTER_MAP_FOR_EVENT_PAYLOAD = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ...
    ['observableReference', SetterForEventPayload.prototype.setObservableReferenceFromJsonable],
    ['observableSemanticId', SetterForEventPayload.prototype.setObservableSemanticIdFromJsonable],
...
const SETTER_MAP_FOR_BASIC_EVENT_ELEMENT = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ...
    ['embeddedDataSpecifications', SetterForBasicEventElement.prototype.setEmbeddedDataSpecificationsFromJsonable],
...
const SETTER_MAP_FOR_OPERATION = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ...
    ['supplementalSemanticIds', SetterForOperation.prototype.setSupplementalSemanticIdsFromJsonable],
    ['qualifiers', SetterForOperation.prototype.setQualifiersFromJsonable],
    ['embeddedDataSpecifications', SetterForOperation.prototype.setEmbeddedDataSpecificationsFromJsonable],
...
const SETTER_MAP_FOR_OPERATION_VARIABLE = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ['value', SetterForOperationVariable.prototype.setValueFromJsonable],
]);

const SETTER_MAP_FOR_CAPABILITY = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ...
    ['embeddedDataSpecifications', SetterForCapability.prototype.setEmbeddedDataSpecificationsFromJsonable],
    [
        // The model type here is used only for verification, not for dispatch.
        'modelType',
...
const SETTER_MAP_FOR_CONCEPT_DESCRIPTION = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ...
    ['administration', SetterForConceptDescription.prototype.setAdministrationFromJsonable],
    ['id', SetterForConceptDescription.prototype.setIdFromJsonable],
    ['embeddedDataSpecifications', SetterForConceptDescription.prototype.setEmbeddedDataSpecificationsFromJsonable],
...
const SETTER_MAP_FOR_REFERENCE = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ['type', SetterForReference.prototype.setTypeFromJsonable],
    ['referredSemanticId', SetterForReference.prototype.setReferredSemanticIdFromJsonable],
    ['keys', SetterForReference.prototype.setKeysFromJsonable],
]);

const SETTER_MAP_FOR_KEY = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
...
>([
    ...
    ['LangStringPreferredNameTypeIec61360', langStringPreferredNameTypeIec61360FromJsonable],
...
const SETTER_MAP_FOR_LANG_STRING_NAME_TYPE = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
...
const SETTER_MAP_FOR_LANG_STRING_TEXT_TYPE = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
...
const SETTER_MAP_FOR_ENVIRONMENT = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ['assetAdministrationShells', SetterForEnvironment.prototype.setAssetAdministrationShellsFromJsonable],
    ['submodels', SetterForEnvironment.prototype.setSubmodelsFromJsonable],
    ['conceptDescriptions', SetterForEnvironment.prototype.setConceptDescriptionsFromJsonable],
]);

const DATA_SPECIFICATION_CONTENT_FROM_JSONABLE_DISPATCH = new Map<
    string,
    (JsonValue) => AasCommon.Either<AasTypes.IDataSpecificationContent, DeserializationError>
...
const SETTER_MAP_FOR_EMBEDDED_DATA_SPECIFICATION = new Map<
    ...
    (jsonable: JsonValue) => DeserializationError | null
>([
    ['dataSpecificationContent', SetterForEmbeddedDataSpecification.prototype.setDataSpecificationContentFromJsonable],
    ['dataSpecification', SetterForEmbeddedDataSpecification.prototype.setDataSpecificationFromJsonable],
]);

const SETTER_MAP_FOR_LEVEL_TYPE = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
...
const SETTER_MAP_FOR_VALUE_REFERENCE_PAIR = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
...
const SETTER_MAP_FOR_VALUE_LIST = new Map<string, (jsonable: JsonValue) => DeserializationError | null>([
    ['valueReferencePairs', SetterForValueList.prototype.setValueReferencePairsFromJsonable],
]);
...
const SETTER_MAP_FOR_LANG_STRING_PREFERRED_NAME_TYPE_IEC_61360 = new Map<
    ...
    (jsonable: JsonValue) => DeserializationError | null
>([
    ['language', SetterForLangStringPreferredNameTypeIec61360.prototype.setLanguageFromJsonable],
...
const SETTER_MAP_FOR_LANG_STRING_SHORT_NAME_TYPE_IEC_61360 = new Map<
    ...
    (jsonable: JsonValue) => DeserializationError | null
>([
    ['language', SetterForLangStringShortNameTypeIec61360.prototype.setLanguageFromJsonable],
...
const SETTER_MAP_FOR_LANG_STRING_DEFINITION_TYPE_IEC_61360 = new Map<
    ...
    (jsonable: JsonValue) => DeserializationError | null
>([
    ['language', SetterForLangStringDefinitionTypeIec61360.prototype.setLanguageFromJsonable],
...
const SETTER_MAP_FOR_DATA_SPECIFICATION_IEC_61360 = new Map<
    ...
    (jsonable: JsonValue) => DeserializationError | null
>([
    ['preferredName', SetterForDataSpecificationIec61360.prototype.setPreferredNameFromJsonable],
    ...
    ['sourceOfDefinition', SetterForDataSpecificationIec61360.prototype.setSourceOfDefinitionFromJsonable],
    ...
    ['definition', SetterForDataSpecificationIec61360.prototype.setDefinitionFromJsonable],
    ['valueFormat', SetterForDataSpecificationIec61360.prototype.setValueFormatFromJsonable],
...
class Serializer extends AasTypes.AbstractTransformer<JsonObject> {
     ...
     * @returns JSON-able representation
     */
    transformAdministrativeInformation(that: AasTypes.AdministrativeInformation): JsonObject {
        const jsonable: JsonObject = {};
     ...
     * @returns JSON-able representation
     */
    transformAssetAdministrationShell(that: AasTypes.AssetAdministrationShell): JsonObject {
        const jsonable: JsonObject = {};
    ...
    transformSubmodelElementList(that: AasTypes.SubmodelElementList): JsonObject {
        ...
        jsonable['typeValueListElement'] = AasStringification.mustAasSubmodelElementsToString(
     ...
     * @returns JSON-able representation
     */
    transformSubmodelElementCollection(that: AasTypes.SubmodelElementCollection): JsonObject {
        const jsonable: JsonObject = {};
     ...
     * @returns JSON-able representation
     */
    transformAnnotatedRelationshipElement(that: AasTypes.AnnotatedRelationshipElement): JsonObject {
        const jsonable: JsonObject = {};
     ...
     * @returns JSON-able representation
     */
    transformEmbeddedDataSpecification(that: AasTypes.EmbeddedDataSpecification): JsonObject {
        const jsonable: JsonObject = {};
     ...
     * @returns JSON-able representation
     */
    transformLangStringPreferredNameTypeIec61360(that: AasTypes.LangStringPreferredNameTypeIec61360): JsonObject {
        const jsonable: JsonObject = {};
     ...
     * @returns JSON-able representation
     */
    transformLangStringShortNameTypeIec61360(that: AasTypes.LangStringShortNameTypeIec61360): JsonObject {
        const jsonable: JsonObject = {};
     ...
     * @returns JSON-able representation
     */
    transformLangStringDefinitionTypeIec61360(that: AasTypes.LangStringDefinitionTypeIec61360): JsonObject {
        const jsonable: JsonObject = {};
     ...
     * @returns JSON-able representation
     */
    transformDataSpecificationIec61360(that: AasTypes.DataSpecificationIec61360): JsonObject {
        const jsonable: JsonObject = {};
