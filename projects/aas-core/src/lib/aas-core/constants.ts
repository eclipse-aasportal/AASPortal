 ...
 */
export const VALID_CATEGORIES_FOR_DATA_ELEMENT = new Set<string>(['CONSTANT', 'PARAMETER', 'VARIABLE']);

/**
 * Enumeration of all identifiable elements within an asset administration shell.
 */
export const GENERIC_FRAGMENT_KEYS = new Set<AasTypes.KeyTypes>([AasTypes.KeyTypes.FragmentReference]);

/**
 * Enumeration of different key value types within a key.
 */
export const GENERIC_GLOBALLY_IDENTIFIABLES = new Set<AasTypes.KeyTypes>([AasTypes.KeyTypes.GlobalReference]);
