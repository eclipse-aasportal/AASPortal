...
describe('AASXPackage', () => {
    ...
    beforeEach(async () => {
        ...
        const file = fileURLToPath(new URL('../test/assets/example-motor.aasx', import.meta.url));
    ...
    describe('write', () => {
        it('writes a file into the zip archive', async () => {
            const file = fileURLToPath(new URL('../test/assets/test.xml', import.meta.url));
    ...
    describe('remove', () => {
        ...
        describe('setThumbnail', () => {
            it('sets a new thumbnail image', async () => {
                const file = fileURLToPath(new URL('../test/assets/thumbnail.png', import.meta.url));
