...
describe('XmlReader', function () {
    describe('with default namespace v2.0', function () {
        ...
        beforeAll(async function () {
            path = fileURLToPath(new URL('../../test/assets/aas-default-namespace.xml', import.meta.url));
    ...
    describe('with prefix namespace v1.0', function () {
        ...
        beforeAll(async function () {
            path = fileURLToPath(new URL('../../test/assets/aas-prefix-namespace.xml', import.meta.url));
            xml = (await readFile(path)).toString();
        });
