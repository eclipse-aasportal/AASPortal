...
import { MongoDBIdentityProvider } from '../../app/auth/mongo-db-identity-provider.js';
...
describe('MongoDBIdentityProvider', () => {
    ...
    beforeEach(() => {
        ...
        identityProvider = new MongoDBIdentityProvider(logger, variable, connectionProvider);
    });
