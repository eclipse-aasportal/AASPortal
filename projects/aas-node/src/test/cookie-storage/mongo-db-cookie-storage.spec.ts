...
import { MongoDBCookieStorage } from '../../app/cookie-storage/mongo-db-cookie-storage.js';
...
describe('MongoDBCookieStorage', () => {
    ...
    describe('getCookie', () => {
        ...
        it('should return the cookie', async () => {
            await expect(storage.getCookie('john.doe@email.com', 'cookie1')).resolves.toEqual({
                name: 'cookie1',
                data: 'data',
            } satisfies Cookie);
        });
