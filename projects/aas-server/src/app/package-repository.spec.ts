...
describe('PackageRepository', () => {
    ...
    beforeEach(async () => {
        ...
        variable = createSpyObj<Variable>(
            {},
            {
                ...
                PAGE_SIZE: 100,
                CACHE_SIZE: 100,
                ASSETS: fileURLToPath(new URL('../test/assets', import.meta.url)),
            },
        );
    ...
    describe('add', () => {
        it('adds an aasx file', async () => {
            ...
            const path = fileURLToPath(new URL('../test/assets/mvp-dpp-1.0.0.aasx', import.meta.url));
    ...
    describe('update', () => {
        it('updates an aasx file', async () => {
            const db = await createDatabase();
            const repository = new PackageRepository(logger, variable, db, aasxBuilder);
            const path = fileURLToPath(new URL('../test/assets/example-motor.aasx', import.meta.url));
