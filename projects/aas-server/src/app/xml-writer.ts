...
import { convertToString } from './utilities.js';
...
export class XmlWriter extends AASWriter {
    ...
    public override write(env: aas.Environment): string {
        const envNode = this.appendChild(this.document, 'environment') as Element;
    ...
    private appendChild(parent: Node, localName: string): Node {
