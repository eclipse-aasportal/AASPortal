...
export * from './lib/components/auth/auth.service';
...
export * from './lib/components/notify/notify.component';
export * from './lib/components/notify/notify.service';
...
export * from './lib/views/contact-information/contact-informations.view';
export * from './lib/views/contact-information/contact-informations';
...
export * from './lib/views/view-composite';
export * from './lib/views/view-leaf';
